...
const styles = StyleSheet.create({
  ...
  scoreLabel: { color: '#E0E7FF', fontWeight: '700', letterSpacing: 0.4 },
  scoreRow: { flexDirection: 'row', alignItems: 'flex-end', gap: 6 },
  scoreValue: { color: 'white', fontSize: 36, fontWeight: '800' },
  scoreMax: { color: '#BFDBFE', fontSize: 14, marginBottom: 6 },
  scoreTier: { color: '#DBEAFE', fontWeight: '700' },
  progressTrack: {
    height: 8,
    borderRadius: 999,
  ...
  scoreHint: { color: '#E0E7FF', fontSize: 12 },
  card: {
  ...
  metric: { color: colors.text, fontSize: 15, fontWeight: '600' },
