...
export default function UniPassport() {
  ...
  const myRecords = records
    .filter((r: Record) => r.name === "Aditi Sharma" || r.status === "Issued")
    .slice(0, 3);
  const [activeCredential, setActiveCredential] = useState<Record | null>(
    myRecords[0] || null,
  );
          ...
          {activeCredential ? (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-heading font-bold hidden lg:block">
                  Credential Details
                </h2>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-50 text-center">
                      <p className="text-[10px] text-slate-400 uppercase mb-1">
                        Issuer Blockchain Identity (DID)
                      </p>
