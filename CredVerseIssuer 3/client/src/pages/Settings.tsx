                                ...
                                <div className="p-4 border rounded-lg space-y-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Input
                                            ...
                                            className="font-mono"
                                        />
                                        <Tooltip><TooltipTrigger asChild><Button variant="outline" size="icon" onClick={handleCopyApiKey} aria-label="Copy Live API Key">{copiedKey ? <Check className="h-4 w-4 text-green-600" /> : <Copy className="h-4 w-4" />}</Button></TooltipTrigger><TooltipContent><p>Copy Live API Key</p></TooltipContent></Tooltip>
                                        <Tooltip><TooltipTrigger asChild><Button variant="outline" size="icon" onClick={handleRotateApiKey} aria-label="Rotate Live API Key"><RefreshCw className="h-4 w-4" /></Button></TooltipTrigger><TooltipContent><p>Rotate Live API Key</p></TooltipContent></Tooltip>
                                    </div>
                                ...
                                <div className="p-4 border rounded-lg border-dashed">
                                    ...
                                    <div className="flex items-center gap-2 mt-4">
                                        <Input
                                            ...
                                            className="font-mono"
                                        />
                                        <Tooltip><TooltipTrigger asChild><Button variant="outline" size="icon" aria-label="Copy Test API Key"><Copy className="h-4 w-4" /></Button></TooltipTrigger><TooltipContent><p>Copy Test API Key</p></TooltipContent></Tooltip>
                                    </div>
                                </div>
