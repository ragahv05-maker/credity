...
export const RECENT_ACTIVITY = [
  {
    id: "1",
    action: "Issued Batch",
    details: "B.Tech Computer Science 2025",
    user: "Admin System",
    time: "2 mins ago",
    status: "completed",
  },
  {
    ...
    details: "Updated 'Merit Certificate' layout",
    user: "Sarah Jenkins",
    time: "15 mins ago",
    status: "completed",
  },
  {
    ...
    details: "ID: 992834 - Academic Dishonesty",
  ...
  },
  {
    id: "4",
    action: "Bulk Upload",
    details: "MBA Semester 4 Results.csv",
    user: "John Doe",
    time: "3 hours ago",
    status: "processing",
  },
  {
    id: "5",
    action: "System Audit",
    details: "Monthly security scan completed",
    user: "System",
    time: "5 hours ago",
    status: "completed",
  },
...
export const AUDIT_LOGS = [
  {
    ...
    details: "Issued Degree Certificate",
  },
  {
    id: "log-2",
    action: "Template Modified",
    user: "Sarah Jenkins",
    target: "Medical Lab Report",
    timestamp: "Today, 09:15 AM",
    details: "Updated layout fields",
  },
  {
    id: "log-3",
  ...
  },
  {
    ...
    details: "Reason: Administrative Error",
  },
  {
    id: "log-5",
    action: "Bulk Upload",
    user: "Admin User",
    target: "Batch_2025_May_1.csv",
    timestamp: "May 15, 2025",
    details: "Processed 120 records",
  },
];
