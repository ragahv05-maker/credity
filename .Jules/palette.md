...
## 2024-07-03 - Accessible Icon Buttons
**Learning:** Icon-only buttons without accessible names are a common accessibility anti-pattern that makes the interface difficult for screen reader users to understand.
**Action:** Always add descriptive `aria-label` attributes to interactive elements that rely solely on visual icons.
