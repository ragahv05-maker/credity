...
## 2024-10-25 - Duplicate imports during iterative patching
**Learning:** Running Node patch scripts multiple times during iterative debugging can inject duplicate imports, causing `TS2300: Duplicate identifier` errors.
**Action:** Always wrap import injections in a safeguard condition (e.g., `if (!content.includes('import ...'))`) within the patch script.
