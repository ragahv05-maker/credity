...
function withLegacyDeprecation(
  routeHandler: Router,
...
export async function registerRoutes(
  ...
  app.use(
    "/api",
    withLegacyDeprecation(credentialsRoutes, "/api/v1/wallet/credentials"),
  );
  ...
  app.use(
    "/api/trust-score",
    withLegacyDeprecation(trustScoreRoutes, "/api/v1/trust-score"),
  );
  app.use(
    "/api/reputation",
    withLegacyDeprecation(reputationRoutes, "/api/v1/reputation"),
  );
  app.use(
    "/api",
    withLegacyDeprecation(complianceRoutes, "/api/v1/compliance"),
  );
  app.use(
    "/api/connections",
    withLegacyDeprecation(connectionsRoutes, "/api/v1/connections"),
  );
  if (allowDemoRoutes) {
  ...
  app.use(
    "/api/identity",
    withLegacyDeprecation(identityRoutes, "/api/v1/identity"),
  );
