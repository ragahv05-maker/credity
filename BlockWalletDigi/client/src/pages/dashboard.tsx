...
export default function Dashboard() {
  ...
  const [selectedCred, setSelectedCred] = useState<WalletCredential | null>(
    null,
  );
            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  {stats.activeShares || 0} Active Shares
                </p>
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                      ...
                      <Badge className="bg-white/20 hover:bg-white/30 text-white border-none backdrop-blur-sm">
                        {credentials[0].anchorStatus === "anchored"
                          ? "⛓ Verified"
                          : "Pending"}
                      </Badge>
                    </div>
