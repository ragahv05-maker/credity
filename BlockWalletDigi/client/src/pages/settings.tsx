                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button size="icon" variant="outline" onClick={handleCopyKey}>
                        <span className="sr-only">Copy recovery key</span>
                        {copied ? <CheckCircle2 className="w-4 h-4 text-green-600" aria-hidden="true" /> : <Copy className="w-4 h-4" aria-hidden="true" />}
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>
                      <p>Copy recovery key</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              </div>
