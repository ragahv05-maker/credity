...
## 2026-03-05 - Optimize React array filtering
**Learning:** Filtering arrays on every render in React without memoization leads to unnecessary recalculations.
**Action:** Always wrap derived filtering data with useMemo when processing arrays inside functional components.
